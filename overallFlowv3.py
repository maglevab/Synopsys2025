...
academicSample, _ = train_test_split(academic, train_size=300, stratify=academic["label"], random_state=10)
news = pd.read_csv("/Users/arahan/Desktop/Synopsys2025/Data/newsv5.csv")
newsSample, _ = train_test_split(news, train_size=300, stratify=news['label'], random_state=10)
litH = pd.read_csv("/Users/arahan/Desktop/Synopsys2025/Data/litDatasetHUMAN.csv")
litHSample, _ = train_test_split(litH, train_size=150, random_state=10)
litAI = pd.read_csv("/Users/arahan/Desktop/Synopsys2025/Data/litDataAI.csv")
litAISample, _ = train_test_split(litAI, train_size=150, random_state=10)
...
mediaExpert = DebertaV2ForSequenceClassification.from_pretrained('/Users/arahan/Desktop/Synopsys2025/ExpertModels/NewsModelv1')
